...
abstract class AppLocalizations {
  ...
  /// No description provided for @analyzeCropWithAI.
  ///
  /// In en, this message translates to:
  /// **'Analyze Crop with AI'**
  String get analyzeCropWithAI;
  ...
  /// No description provided for @imageSuccessfullyCaptured.
  ///
  /// In en, this message translates to:
  /// **'Image successfully captured!'**
  String get imageSuccessfullyCaptured;
